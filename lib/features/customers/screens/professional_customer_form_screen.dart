    ...
    try {
      ...
      if (_existingCustomer != null) {
        ...
        _billingAddressController.text =
            _existingCustomer!.billingAddress ?? '';
        _shippingAddressController.text =
            _existingCustomer!.shippingAddress ?? '';
        _uenController.text = _existingCustomer!.uen ?? '';
        _gstNumberController.text =
            _existingCustomer!.gstRegistrationNumber ?? '';
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SwitchListTile(
                              ...
                              subtitle:
                                  const Text('Customer can receive invoices'),
                              value: _isActive,
                              onChanged: (value) =>
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SwitchListTile(
                              ...
                              subtitle:
                                  const Text('Customer is registered for GST'),
  ...
  Future<void> _saveCustomer() async {
    ...
    try {
      ...
      final customer = Customer(
        ...
        gstRegistrationNumber: _gstNumberController.text.trim().isEmpty
            ? null
