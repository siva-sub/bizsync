...
class IrasConfig {
  ...
  static final IrasCredentialsService _credentialsService =
      IrasCredentialsService.instance;
  ...
  static String get gstRegisterCheckUrl =>
      '$gstListingBaseUrl/SearchGSTRegistered';
  ...
  static String get gstF5SubmissionUrl =>
      '$gstReturnBaseUrl/SubmitF5ReturnCorpPass';
  static String get gstF8SubmissionUrl =>
      '$gstReturnBaseUrl/SubmitF8ReturnCorpPass';
  static String get gstF7EditUrl => '$gstReturnBaseUrl/EditF7ReturnCorpPass';
  static String get gstTransactionListingUrl =>
      '$gstReturnBaseUrl/SubmitGSTTransactionListingCorpPass';
  ...
  static Future<String> getClientSecret() =>
      _credentialsService.getClientSecret();
  ...
  static Future<Map<String, String>> getAuthenticatedHeadersAsync(
