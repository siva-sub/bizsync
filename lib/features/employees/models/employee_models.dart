...
enum EmploymentStatus { active, onLeave, suspended, terminated, retired }

/// Employee type enumeration
enum EmployeeType { fullTime, partTime, contract, intern, freelancer }
...
class CRDTEmployee implements CRDTModel {
  ...
  CRDTEmployee({
    ...
    if (compassionateLeave > 0)
      compassionateLeaveBalance.increment(compassionateLeave);
  ...
  void updatePersonalInfo({
    ...
    if (newPreferredName != null)
      preferredName.setValue(newPreferredName, timestamp);
  ...
  void updateSalary({
    ...
    if (newPayFrequency != null)
      payFrequency.setValue(newPayFrequency, timestamp);
  ...
  void updateWorkPermit({
    ...
    if (newPermitType != null)
      workPermitType.setValue(newPermitType, timestamp);
    if (newPermitNumber != null)
      workPermitNumber.setValue(newPermitNumber, timestamp);
    if (newPermitExpiry != null)
      workPermitExpiry.setValue(newPermitExpiry, timestamp);
  ...
  void updateCpfInfo({
    ...
    if (newOrdinaryWage != null)
      cpfOrdinaryWage.setValue(newOrdinaryWage, timestamp);
    if (newAdditionalWage != null)
      cpfAdditionalWage.setValue(newAdditionalWage, timestamp);
    _updateTimestamp(timestamp);
  }
  ...
  void updateEmergencyContact({
    ...
    if (relationship != null)
      emergencyContactRelationship.setValue(relationship, timestamp);
    _updateTimestamp(timestamp);
  }
  ...
  Map<String, double> get cpfRates {
    ...
    if (residency == SingaporeResidencyStatus.prFirst2Years) {
      ...
      if (age >= 55 && age < 60)
        return {'employee_rate': 0.035, 'employer_rate': 0.035};
      if (age >= 60 && age < 65)
        return {'employee_rate': 0.025, 'employer_rate': 0.025};
    ...
    if (age >= 55 && age < 60)
      return {'employee_rate': 0.13, 'employer_rate': 0.13};
    if (age >= 60 && age < 65)
      return {'employee_rate': 0.075, 'employer_rate': 0.09};
  ...
  factory CRDTEmployee.fromCRDTJson(Map<String, dynamic> json) {
    final employee = CRDTEmployee(
      ...
      version: VectorClock.fromString(
          json['version'] as String, json['node_id'] as String),
    ...
    // Restore CRDT states
    employee.employeeId =
        LWWRegister.fromJson(json['employee_id'] as Map<String, dynamic>);
    employee.firstName =
        LWWRegister.fromJson(json['first_name'] as Map<String, dynamic>);
    employee.lastName =
        LWWRegister.fromJson(json['last_name'] as Map<String, dynamic>);
    employee.preferredName =
        LWWRegister.fromJson(json['preferred_name'] as Map<String, dynamic>);
    employee.email =
        LWWRegister.fromJson(json['email'] as Map<String, dynamic>);
    employee.phone =
        LWWRegister.fromJson(json['phone'] as Map<String, dynamic>);
    employee.address =
        LWWRegister.fromJson(json['address'] as Map<String, dynamic>);
    employee.dateOfBirth =
        LWWRegister.fromJson(json['date_of_birth'] as Map<String, dynamic>);
    employee.nationality =
        LWWRegister.fromJson(json['nationality'] as Map<String, dynamic>);
    employee.nricFinNumber =
        LWWRegister.fromJson(json['nric_fin_number'] as Map<String, dynamic>);

    employee.jobTitle =
        LWWRegister.fromJson(json['job_title'] as Map<String, dynamic>);
    employee.department =
        LWWRegister.fromJson(json['department'] as Map<String, dynamic>);
    employee.managerId =
        LWWRegister.fromJson(json['manager_id'] as Map<String, dynamic>);
    employee.startDate =
        LWWRegister.fromJson(json['start_date'] as Map<String, dynamic>);
    employee.endDate =
        LWWRegister.fromJson(json['end_date'] as Map<String, dynamic>);
    employee.employmentStatus =
        LWWRegister.fromJson(json['employment_status'] as Map<String, dynamic>);
    employee.employmentType =
        LWWRegister.fromJson(json['employment_type'] as Map<String, dynamic>);

    employee.workPermitType =
        LWWRegister.fromJson(json['work_permit_type'] as Map<String, dynamic>);
    employee.workPermitNumber = LWWRegister.fromJson(
        json['work_permit_number'] as Map<String, dynamic>);
    employee.workPermitExpiry = LWWRegister.fromJson(
        json['work_permit_expiry'] as Map<String, dynamic>);
    employee.isLocalEmployee =
        LWWRegister.fromJson(json['is_local_employee'] as Map<String, dynamic>);

    employee.basicSalary =
        LWWRegister.fromJson(json['basic_salary'] as Map<String, dynamic>);
    employee.allowances =
        LWWRegister.fromJson(json['allowances'] as Map<String, dynamic>);
    employee.payFrequency =
        LWWRegister.fromJson(json['pay_frequency'] as Map<String, dynamic>);
    employee.bankAccount =
        LWWRegister.fromJson(json['bank_account'] as Map<String, dynamic>);
    employee.bankCode =
        LWWRegister.fromJson(json['bank_code'] as Map<String, dynamic>);

    employee.cpfNumber =
        LWWRegister.fromJson(json['cpf_number'] as Map<String, dynamic>);
    employee.isCpfMember =
        LWWRegister.fromJson(json['is_cpf_member'] as Map<String, dynamic>);
    employee.cpfContributionRate = LWWRegister.fromJson(
        json['cpf_contribution_rate'] as Map<String, dynamic>);
    employee.cpfOrdinaryWage =
        LWWRegister.fromJson(json['cpf_ordinary_wage'] as Map<String, dynamic>);
    employee.cpfAdditionalWage = LWWRegister.fromJson(
        json['cpf_additional_wage'] as Map<String, dynamic>);

    employee.annualLeaveBalance = PNCounter.fromJson(
        json['annual_leave_balance'] as Map<String, dynamic>);
    employee.sickLeaveBalance =
        PNCounter.fromJson(json['sick_leave_balance'] as Map<String, dynamic>);
    employee.maternitylLeaveBalance = PNCounter.fromJson(
        json['maternity_leave_balance'] as Map<String, dynamic>);
    employee.paternitylLeaveBalance = PNCounter.fromJson(
        json['paternity_leave_balance'] as Map<String, dynamic>);
    employee.compassionateLeaveBalance = PNCounter.fromJson(
        json['compassionate_leave_balance'] as Map<String, dynamic>);

    employee.skills = ORSet.fromJson(json['skills'] as Map<String, dynamic>);
    employee.certifications =
        ORSet.fromJson(json['certifications'] as Map<String, dynamic>);
    employee.tags = ORSet.fromJson(json['tags'] as Map<String, dynamic>);

    employee.emergencyContactName = LWWRegister.fromJson(
        json['emergency_contact_name'] as Map<String, dynamic>);
    employee.emergencyContactPhone = LWWRegister.fromJson(
        json['emergency_contact_phone'] as Map<String, dynamic>);
    employee.emergencyContactRelationship = LWWRegister.fromJson(
        json['emergency_contact_relationship'] as Map<String, dynamic>);

    employee.metadata =
        LWWRegister.fromJson(json['metadata'] as Map<String, dynamic>);
    employee.profilePicture =
        LWWRegister.fromJson(json['profile_picture'] as Map<String, dynamic>);
