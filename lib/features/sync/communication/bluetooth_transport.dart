...
/// Bluetooth transport implementation for P2P communication (STUB)
/// This is a stub implementation since flutter_bluetooth_serial is not available
class BluetoothTransport extends P2PTransport {
  ...
  Future<bool> isAvailable() async {
    // Bluetooth not available in stub implementation
    return false;
  }

  @override
  Future<void> initialize() async {
    debugPrint('Bluetooth transport initialized (stub)');
  }
  ...
  Future<void> dispose() async {
    ...
    debugPrint('Bluetooth transport disposed (stub)');
  }
  ...
  Future<void> startAdvertising({
    ...
    debugPrint('Bluetooth advertising not available (stub)');
  }

  @override
  Future<void> stopAdvertising() async {
    debugPrint('Bluetooth advertising stopped (stub)');
  }
  ...
  Stream<DeviceInfo> startDiscovery({
    ...
    debugPrint('Bluetooth discovery not available (stub)');
    return _discoveryController.stream;
  }

  @override
  Future<void> stopDiscovery() async {
    debugPrint('Bluetooth discovery stopped (stub)');
  }

  @override
  Future<P2PConnection> connect(DeviceInfo device) async {
    throw UnimplementedError('Bluetooth connection not available (stub)');
  }
  ...
  Future<void> rejectConnection(String connectionId) async {
    debugPrint('Bluetooth connection rejected (stub)');
  }

  @override
  Future<void> disconnect(String connectionId) async {
    debugPrint('Bluetooth disconnection (stub)');
  }

  @override
  Future<void> sendData(String connectionId, Uint8List data) async {
    throw UnimplementedError('Bluetooth data sending not available (stub)');
  }
  ...
  Future<void> updateSettings(Map<String, dynamic> settings) async {
    debugPrint('Bluetooth settings update not available (stub)');
  }
}
