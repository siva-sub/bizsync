...
class OnboardingService {
  ...
  bool isStepCompleted(OnboardingStep step) {
    final currentStepIndex = OnboardingStep.values.indexOf(_currentState.currentStep);
  ...
  double get progressPercentage {
    ...
    final currentIndex = OnboardingStep.values.indexOf(_currentState.currentStep);
  ...
  Future<void> updatePermission(String permission, bool granted) async {
    final updatedPermissions = Map<String, bool>.from(_currentState.permissions);
