...
class MesaRenderingConfig {
  ...
  void initialize() {
    if (isMesaActive) {
      ...
      debugPrint('MesaRenderingConfig: Initialized with Mesa workarounds enabled');
    }
  }
  ...
  Color getSafeShadowColor(Color color) {
    ...
    if (isMesaActive) {
      return color.withOpacity(color.opacity * 0.3);
    }
    return color;
  }
  ...
  ThemeData applySafeTheme(ThemeData theme) {
    ...
    return theme.copyWith(
      ...
      cardTheme: theme.cardTheme.copyWith(
        ...
        shadowColor: _disableShadows ? Colors.transparent : theme.cardTheme.shadowColor,
      ),
      
      // Adjust app bar theme
      appBarTheme: theme.appBarTheme.copyWith(
        elevation: getSafeElevation(theme.appBarTheme.elevation ?? 4.0),
        shadowColor: _disableShadows ? Colors.transparent : theme.appBarTheme.shadowColor,
      ),
      ...
      floatingActionButtonTheme: theme.floatingActionButtonTheme.copyWith(
        elevation: getSafeElevation(theme.floatingActionButtonTheme.elevation ?? 6.0),
        disabledElevation: getSafeElevation(theme.floatingActionButtonTheme.disabledElevation ?? 0.0),
        highlightElevation: getSafeElevation(theme.floatingActionButtonTheme.highlightElevation ?? 12.0),
      ),
      ...
      bottomSheetTheme: theme.bottomSheetTheme.copyWith(
        ...
        modalElevation: getSafeElevation(theme.bottomSheetTheme.modalElevation ?? 1.0),
      ),
