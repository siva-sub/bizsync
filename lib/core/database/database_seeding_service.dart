    ...
    for (final taxRateData in taxRates) {
      ...
      await db.insert('tax_rates_crdt', {
        ...
        'crdt_data': jsonEncode({
          ...
          'type': {
            'value': taxRateData['type'],
            'timestamp': timestamp.toString()
          },
          'is_active': {
            'value': taxRateData['is_active'],
            'timestamp': timestamp.toString()
          },
        }),
  ...
  Future<void> _createSampleInvoice(Map<String, dynamic> invoiceData) async {
    ...
    await db.insert('invoices_crdt', {
      ...
      'crdt_data': jsonEncode({
        ...
        'issue_date': {
          'value':
              (invoiceData['issue_date'] as DateTime).millisecondsSinceEpoch,
          'timestamp': timestamp.toString()
        },
        'due_date': {
          'value': (invoiceData['due_date'] as DateTime).millisecondsSinceEpoch,
          'timestamp': timestamp.toString()
        },
        'status': {
